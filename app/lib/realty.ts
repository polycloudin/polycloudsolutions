...
/**
 * STUB for Lane A's api-keys.validateApiKey. Looks the inbound key up
 * by sha256 hash against realty_builders.api_key_hash. When Lane A
 * lands, replace with their unified key store.
 */
