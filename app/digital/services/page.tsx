...
export const metadata: Metadata = {
  title: "Digital Services — The nine things we run for you | PolyCloud",
  description:
    "Detailed catalog of every service inside a PolyCloud Digital bundle: Ads, SEO, GMB, Websites, Social, WhatsApp, CRM, Reviews, Analytics.",
};
...
export default function ServicesPage() {
  return (
    <div className="min-h-screen bg-[var(--color-surface)] text-[var(--color-ink)]">
        ...
        <div className="max-w-[1440px] mx-auto relative">
          ...
          <div className="grid md:grid-cols-[1.2fr_1fr] gap-10 md:gap-20 items-end">
            <p className="text-lg md:text-xl text-[var(--color-text-secondary)] max-w-2xl leading-relaxed">
              ...
              work. A human reviews before anything ships. Pick a bundle on the{" "}
              <Link
                href="/digital"
                className="underline decoration-[var(--color-primary-orange)]/40 underline-offset-4"
              >
                Digital page
              </Link>
              ; this page shows exactly what's inside.
            </p>
            <div className="flex flex-wrap gap-3">
              ...
              <Link href="/digital#pricing" className="btn-secondary">
                See bundles
              </Link>
            </div>
          </div>
      ...
      {/* Pricing — Bundles (matches /digital) */}
      <section
        id="pricing"
      ...
      >
        <div className="max-w-[1440px] mx-auto">
          ...
          <p className="text-center text-xs text-[var(--color-text-secondary)] mt-10">
            Full bundle details + custom-scope pricing on the{" "}
            <Link
              href="/digital"
              className="underline decoration-[var(--color-primary-orange)]/40 underline-offset-4"
            >
          ...
          <div className="space-y-10">
            {[
              ...
              },
              {
                ...
                a: "Not usually — that's what agencies do and it doesn't compound. If you really need a one-off (e.g. a website only), that's a custom scope and lives on the Digital page.",
              },
              {
